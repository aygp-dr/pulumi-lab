...
*Important:* Pulumi doesn't officially support FreeBSD and is not available in ports/pkg. This project runs Pulumi 3.145.0 via FreeBSD's Linux compatibility layer. See [[file:docs/FREEBSD_PULUMI_SETUP.md][FreeBSD Setup Guide]] for installation instructions.
